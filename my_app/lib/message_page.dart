...
class _ChatDetailPageState extends State<ChatDetailPage> {
  List<ChatMessage> chatMessage = [
    ...
    ChatMessage(
        message: "Dạo này em cải thiện được nhiều ạ",
        type: MessageType.Receiver),
    ChatMessage(message: "Cố gắng lên em nhé", type: MessageType.Sender),
    ChatMessage(
        message: "Anh cho em thêm bài tập nữa nhé", type: MessageType.Receiver),
    ChatMessage(message: "Ok em", type: MessageType.Sender),
  ];
